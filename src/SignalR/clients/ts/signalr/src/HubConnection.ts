...
export class HubConnection {
    ...
    private async startInternal() {
        ...
        try {
            ...
            // allowReconnect: true
            this.stopPromise = this.stopInternal(e, true);
    ...
    private stopInternal(error?: Error, allowReconnect?: boolean): Promise<void> {
        if (this.connectionState === HubConnectionState.Disconnected) {
        ...
        if (!allowReconnect || this.connectionState !== HubConnectionState.Reconnecting) {
